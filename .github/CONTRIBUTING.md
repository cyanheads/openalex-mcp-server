...
Thanks for using `openalex-mcp-server`. Bugs, feature requests, and documentation gaps all belong in an issue — that's where they get read and picked up.
...
- **This repo** — a tool returns wrong data, an OpenAlex API call fails, a schema doesn't match reality, or a description misleads the model.
...
- The tool or prompt involved, and the arguments you called it with.
